                ...
                <div class="panel-heading">
                	<div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" align="right">
                            <button type="button" name="add" id="add_button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#orderModal">Add</button>    	
                        </div>
                    </div>
                </div>
    			...
    			<div class="modal-content">
    				...
    				<div class="modal-body">
						...
						<div class="form-group">
							...
							<hr /> -->
							<textarea name="span_product_details" id="span_product_details" class="form-control" required></textarea>
						</div>
						<div class="form-group">
